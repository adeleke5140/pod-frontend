    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-blue-50 via-transparent to-transparent px-4 font-supreme md:px-8">
      ...
      <footer className="mt-auto flex w-full items-center justify-center gap-2 divide-y">
        ...
        <span>
          ...
          <a href="https://github.com/heypran" target="_blank" rel="noopener noreferrer" className="text-blue-600">
            lovelace
          </a>
          , frontend by{" "}
          <a href="https://github.com/adeleke5140" target="_blank" rel="noopener noreferrer" className="text-blue-600">
            kenny
          </a>
        </span>
      </footer>
